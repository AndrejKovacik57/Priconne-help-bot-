...
class ClanGroup(app_commands.Group):
    ...
    async def check(self, interaction: discord.Interaction):
        ...
        try:
            ...
            await interaction.response.send_message(f"__**Info for clan: \_\_\_**__\nPosition: \_\_\_\nLap: \_\_\_\nTier: (A/B/C/D)\nBoss: \_\_\_\nHits Remaining: \_\_\_")
        except:
            return ""
    ...
    async def addplayer(self, interaction: discord.Interaction, player: str, clan: str):
        ...
        try:
            playerToAdd = service.get_player_by_name(player)
            clanToJoin = service.get_clan_by_name(clan)
